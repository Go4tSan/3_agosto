...
<section class="hero">
    <div class="contenido-hero">
      ...
      <!--  <a class="boton" href="#">Contactar</a> -->
        <a class="btn btn-primary btn-lg nav-link active" aria-current="page" href="contacto">CONTACTAR</a>
    </div>
</section>
...
<main class="contenedor sombra">
    ...
    <div class="servicios">
        <section class="servicio">
            ...
            <p>Aliquam nec feugiat odio. Nunc rutrum, neque vel pharetra congue, lectus lectus volutpat mi, 
            ac ullamcorper nisl urna nec dui.</p>
        </section>
            ...
            <fieldset>
                ...
                <div class="contenedor-campos">
                    ...
                    <div class="campo">
                        ...
                        <label for="exampleInputEmail1">Nunca compartiremos su correo electrónico con nadie más.</label>
                    </div>
                    <div class="campo">
                        <label>Mensaje</label>
                ...
                <div class="alinear-derecha flex">
                    <a class="btn btn-primary btn btn-warning btn-lg nav-link active" aria-current="page" href="enviar">ENVIAR</a>
                </div>
            </fieldset>
        </form>
    </section>
